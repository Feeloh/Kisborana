...
<?php echo form_open($this->uri->uri_string()) ?>
            ...
            <h1 style="font-family: 'PT Serif', serif; font-size: 20pt; align-text: center;" >Sacco Members</h1>
            </div>
            </td>

            <td>
            <div style= "display: flex; justify-content: flex-end;" >
            <input class="form-control col-md-3" type="text" name = "search" placeholder="Search member" aria-label="Search">
...
<?php echo form_close() ?>
        <table class="table table-condensed table-striped table-sm table-bordered" >
            ...
            <a href="#individualMember<?php echo $id;?>" class="btn btn-info btn-sm" data-toggle="modal" data-target="#individualMember<?php echo $id;?>"><i class="far fa-eye"></i></a>
