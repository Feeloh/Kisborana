    ...
    <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link active" href="#">
          ...
          <div align = "right" class="collapse" id="collapseExample"><?php echo anchor("saving_type/index","Saving Types", array("class"=> "text-dark", "style"=>"color:black;font-family: 'PT Serif', serif;"));?> <span class="sr-only">(current)</span>
          </div>
